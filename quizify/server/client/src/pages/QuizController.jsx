...
const QuizController = (CUId) => {
    ...
    const getExams = async () => {
        const { data } = await axios.get('${window.location.origin}/examquestions/' + id.id);
        setQuestions(data);
        userCheck();
    }
    ...
    const securityData = async () => {
        axios.all([
            await axios.get('${window.location.origin}/users/' + CUId.CUId),
            await axios.get('${window.location.origin}/exam/exam/' + id.id)
                ...
                axios.post(`${window.location.origin}/userexams/`, dummyData).then((response) => {
    ...
    const userCheck = async () => {
        try {
            const { data } = await axios.get('${window.location.origin}/userexams/' + CUId.CUId);
