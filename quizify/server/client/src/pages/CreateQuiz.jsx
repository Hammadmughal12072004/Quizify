...
const CreateQuiz = () => {
    ...
    const addQuestion = async (e) => {
        ...
        if (correctOption == undefined) {
            ...
            axios.post(`${window.location.origin}/examquestions/`, newQuestion).then((response) => {
    ...
    const handleOptions = ({ data, inputOption }) => {
        ...
        for (let i = 0; i < inputOption.length; i++) {
            ...
            console.log(option);
            axios.put(`${window.location.origin}/examquestions/` + data, option).then((response) => {
                console.log(response.status);
    ...
    const deleteQuestion = (propId) => {
        axios.delete('${window.location.origin}/examquestions/' + propId).then((response) => {
            console.log(response.status);
